...
\begin{rSection}{Projects}
    ...
    \begin{rProject}{Nano Diffusion LLM}{July 2025}{https://github.com/tom-pollak/dllm/}
        \item Simple inference and training of a {\color{blue}\href{https://arxiv.org/pdf/2502.09992}{masked diffusion model}}, aka a finetuned BERT model with a variable amount of masking. Also train a {\color{blue}\href{https://arxiv.org/abs/2506.10892}{Duo}} diffusion model.
    \end{rProject}

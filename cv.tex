...
\CVItem{University of York}{2020 - 2023}{https://york.ac.uk}{
	\textbf{BEng Computer Science} \Date{\textcolor{darkgray}{Average 77\%, Expected First}} \\[4pt]
...
\CVItem{Lady Manners School}{2020}{}{
	\noindent\begin{tabular}{@{} p{0.2\textwidth} p{0.15\textwidth} p{0.3\textwidth} }
		\textbf{A-level} & & \textbf{GCSE} \\[4pt]
		\bluebullet Further Maths (A) & \bluebullet Maths (A) & \bluebullet GCSE: 5 8s, 2 7s, 2 6s, 1 5. \\
...
\CVItem{Derbyshire Police, \textit{Mock Police Witness Interviewee}}{March 2021}{}{
	...
	\vspace*{2pt}\begin{itemize}
		\item Involved being interviewed by police detectives in training, in order to help practice their interview technique on child witnesses.
	\end{itemize}
}
